...
Requires PHP: 7.0.0
Stable tag: 1.74.3
Build time: 2026-09-22T19:11:01+01:00
...
* Contact Form: Fixed a fatal error when a design section held a stored string instead of an array. Existing style hashes are kept, so generated CSS is not rebuilt on every site; the 1.74.3 beta.3 build regenerated it.
...
* LiteSpeed Cache: Page and site purges use the LiteSpeed purge action, so they also work during plugin updates, cron and WP-CLI requests where a response header is dropped.
